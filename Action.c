...
static const struct {
   ...
   { .key = "j/k/h/l: ",  .roInactive = false, .info = "scroll process list" },
   { .key = " Digits: ",  .roInactive = false, .info = "incremental PID search" },
   { .key = "   n /: ",  .roInactive = false, .info = "incremental name search" },
...
static const struct {
   ...
   { .key = "   F9 d: ", .roInactive = true,  .info = "kill process/tagged processes" },
